                            ...
                            <div className='text-right mb-3'>
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" list='tasksearch' type="text" placeholder="Enter task" value={task} onChange={(event) => settask(event.target.value)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" list='tasksearchmass1' type="text" value={description} placeholder="Enter placeholder message" onChange={(event) => setdescription(event.target.value)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" list='tasksearchmass2' type="text" value={pyname} placeholder="Enter error message" onChange={(event) => setpyname(event.target.value)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" list='tasksearchnotes' type="text" value={notes} placeholder="Enter notes" onChange={(event) => setnotes(event.target.value)} />
