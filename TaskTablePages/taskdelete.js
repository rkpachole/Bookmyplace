                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input placeholder="Enter task" type="text" className="form-control" value={task} readonly="readonly" onChange={e => onInputChange(e)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input className="form-control" type="text" placeholder="Enter Description" value={description} readonly="readonly" onChange={e => onInputChange(e)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input className="form-control" type="text" placeholder="Enter Pyname" value={pyname} readonly="readonly" onChange={e => onInputChange(e)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input className="form-control" type="text" placeholder="Enter notes" value={notes} readonly="readonly" onChange={e => onInputChange(e)} />
