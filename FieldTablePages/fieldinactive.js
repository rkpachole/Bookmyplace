                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input placeholder="Enter Field" type="text" className="form-control" value={field} onChange={(event) => setfield(event.target.value)} readonly="readonly" />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" placeholder="Enter placeholder message" value={placeholder_message} onChange={(event) => setplaceholder_message(event.target.value)} readonly="readonly" />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" placeholder="Enter error message" value={error_message} onChange={(event) => seterror_message(event.target.value)} readonly="readonly" />
                                        </div>
                                    </div>
