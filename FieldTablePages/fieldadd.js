                            ...
                            <form onSubmit={LoginFunctionfield} className="form-area">
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" list='fieldsearch' type="text" placeholder="enter the field" value={field} onChange={(event) => setfield(event.target.value)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" list='fieldsearchmass1' type="text" value={placeholder_message} placeholder="Enter placeholder message" onChange={(event) => setplaceholder_message(event.target.value)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" list='fieldsearchmass2' type="text" value={error_message} placeholder="Enter error message" onChange={(event) => seterror_message(event.target.value)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" list='fieldsearchmassdetail' type="text" value={detail_message} placeholder="Enter detail_message" onChange={(event) => setdetail_message(event.target.value)} />
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" list='fieldsearchnote' type="text" value={note} placeholder="Enter note" onChange={(event) => setnote(event.target.value)} />
