                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input placeholder="Enter Field" type="text" className="form-control" value={field} readonly="readonly"onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input className="form-control" type="text" placeholder="Enter placeholder message" value={placeholder_message}  readonly="readonly" onChange={e => onInputChange(e)}/>
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input className="form-control" type="text" placeholder="Enter error message" value={error_message} readonly="readonly" onChange={e => onInputChange(e)}/>
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            {/* <input className="form-control" type="text" placeholder="Enter message 2" /> */}
                                            <input className="form-control" type="text" placeholder="Enter error message" value={detail_message} readonly="readonly" onChange={e => onInputChange(e)}/>
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            ...
                                            <input className="form-control" type="text" placeholder="Enter note" value={note}  readonly="readonly" onChange={e => onInputChange(e)}/>
                                        </div>
                                    </div>
                                </div>
