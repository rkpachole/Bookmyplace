                            ...
                            <div className='text-right mb-3'>
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input placeholder="Enter Field" type="text" name='field' className="form-control" value={field}
                                ...
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='placeholder_message' placeholder="Enter placeholder message" value={placeholder_message}
                                                onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='error_message' placeholder="Enter error message" value={error_message}
                                                onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='detail_message' placeholder="Enter detail_message" value={detail_message}
                                                onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group mb-3">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8">
                                            <input className="form-control" type="text" name='note' placeholder="Enter note" value={note}
                                                onChange={e => onInputChange(e)} />
                                        </div>
                                    </div>
                                </div>
